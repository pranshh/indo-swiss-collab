...
Now we need to proceed to combine the author data between the two datasets. We are choosing to prioritise data from Scopus over data from Web of Science, as it has a wider coverage, and is easier to obtain. In case information on a particular publication is not available in Scopus, we will get it from Web of Science.
...
#Give priority to WoS author data over Scopus author data
dat1 = allentries %>% 
...
saveRDS(paper.details,file = '~/Data/ISRD/publication_details.RData')
saveRDS(author.details,file = '~/Data/ISRD/author_details.RData')
...
write_csv(dat1,file = 'institutions_for_cleaning_20250314.csv')
